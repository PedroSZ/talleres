...
<html>
    ...
    <body>
      ...
      <div id="centrado">
        <!--/*********************************FORMULARIO PARA EL FILTRO*****************************************************/ -->
                           <form method="post" action="listActualizarTaller.php" name="form_filtro" id="form_filtro" style="align-items: center; background:rgba(0,0,0,0.0);">
    ...
    <section style="text-align: center; margin: 0 auto; height: 60%">
        <article style="width:85%; height: 100%;text-align: center; margin: 0 auto;">
                 ...
                 <form method="post"  action="actualizarTalleres.php" name="frm_ActualizarTalleres" id="frm_ActualizarTalleres" style="width: auto; height: auto;">
