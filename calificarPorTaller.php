    ...
    <div id="contenedor">
        ...
        <section style="text-align: center; margin: 0 auto; height: 60%">
            <article style="width:85%; height:auto;text-align: center; margin: 0 auto;">
                 <div class="datagrid">
                 <form method="post" action="listCalificar.php" name="frm_listTalleres" id="frm_listTalleres" style="width: auto; height: 15%;">
        ...
        <tr>
          ...
          <td>
             <select name="taller" type="text" id ="taller">
               <?php
