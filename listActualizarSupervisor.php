    ...
    <body>
      ...
      <div id="centrado">
        <!--/*********************************FORMULARIO PARA EL FILTRO*****************************************************/ -->
                           <form method="post" action="listActualizarSupervisor.php" name="form_filtro" id="form_filtro" style="align-items: center; background:rgba(0,0,0,0.0);">
    ...
    <section style="text-align: center; margin: 0 auto; height: 60%">
        <article style="width:60%; height: 100%;text-align: center; margin: 0 auto;">
             ...
             <div class="datagrid">
                 ...
                 <form method="post" action="actualizarSupervisores.php" name="frm_ActualizarSupervisores" id="frm_ActualizarSupervisores" style="width: auto; height: auto;">
