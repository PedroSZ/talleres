...
<div id="centrado">
              <form method="post" action="listEstudiantes.php" name="form_filtro" id="form_filtro" style="align-items: center; background:rgba(0,0,0,0.0);">
        ...
        <section style="text-align: center; margin: 0 auto; height: 60%">
            <article style="width:85%; height: 100%;text-align: center; margin: 0 auto;">
                 ...
                 <div class="datagrid">
                 <form method="post" action="modulos\mdl_delEstudiantes.php" name="frm_listEstudiantes" id="frm_listEstudiantes" style="width: auto; height: auto;">
